...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private TextView recuperarpass;
...
//        mLoginFormView = findViewById(R.id.login_form);
        ...
        registro = (TextView) findViewById(R.id.nocuenta);
        recuperarpass = (TextView)findViewById(R.id.olvidopass);

        registro.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent();
                myIntent.setClass(LoginActivity.this, registro.class);
                LoginActivity.this.startActivity(myIntent);
            }
        });
    }
